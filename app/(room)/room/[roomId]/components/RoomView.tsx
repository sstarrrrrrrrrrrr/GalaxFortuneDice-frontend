...
function RoomDialogModal({
  ...
  return (
    <div className="absolute inset-0 z-50 flex items-center justify-center bg-[#02031d]/72 backdrop-blur-[7px]">
      <section className="relative mt-[18px] w-[min(620px,72vw)] overflow-hidden rounded-[18px] border border-[#356fff] bg-[linear-gradient(180deg,rgba(10,24,139,0.92),rgba(3,10,78,0.96))] px-[52px] pb-[32px] pt-[70px] text-center shadow-[0_22px_64px_rgba(0,0,0,0.46),0_0_28px_rgba(54,93,255,0.5),inset_0_1px_0_rgba(120,180,255,0.32)]">
        <div className="pointer-events-none absolute inset-0 overflow-hidden rounded-[22px]">
          ...
          <Image
            ...
            width={128}
            height={128}
            className="absolute -left-[2%] top-[47%] h-[92px] w-[92px] rotate-[-18deg] object-contain opacity-18"
          />
          <Image
            src="/images/dice.png"
            alt=""
            width={142}
            height={142}
            className="absolute -right-[2%] top-[33%] h-[112px] w-[112px] rotate-[18deg] object-contain opacity-16"
          />
        </div>
        <div className="absolute left-1/2 top-0 flex h-[96px] w-[96px] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-[#704cff]/70 bg-[radial-gradient(circle_at_45%_28%,rgba(184,116,255,0.94),rgba(37,52,217,0.92)_52%,rgba(20,215,255,0.82))] shadow-[0_0_24px_rgba(126,67,255,0.82),0_0_34px_rgba(18,207,255,0.36)]">
          ...
          <Image
            ...
            width={82}
            height={82}
            className="relative h-[56px] w-[56px] object-contain drop-shadow-[0_0_16px_rgba(255,255,255,0.5)]"
          />
        </div>
        <div className="relative mx-auto mb-[14px] flex items-center justify-center gap-[16px]">
          <span className="h-px w-[92px] bg-[linear-gradient(90deg,transparent,#5d72ff)]" />
          ...
          <span className="text-[28px] text-[#6e8cff] [text-shadow:0_0_14px_rgba(120,150,255,0.9)]">◆</span>
          <span className="h-px w-[92px] bg-[linear-gradient(90deg,#5d72ff,transparent)]" />
        </div>
        <p className="relative mx-auto max-w-[460px] break-words text-[clamp(16px,1.08vw,20px)] font-bold leading-[1.55] text-white/90 [text-wrap:balance] [text-shadow:0_0_10px_rgba(68,90,255,0.36)]">
        ...
        <div className="relative mt-[28px] flex justify-center gap-[24px]">
          {onCancel && (
            <button
              type="button"
              onClick={onCancel}
              disabled={busy}
              className="h-[52px] min-w-[148px] rounded-[10px] border border-[#4262ff] bg-[linear-gradient(180deg,rgba(14,23,111,0.86),rgba(8,12,76,0.92))] px-6 text-[clamp(15px,1.04vw,18px)] font-black text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_0_15px_rgba(57,84,255,0.22)] transition hover:-translate-y-[1px] hover:border-[#7891ff] disabled:cursor-wait disabled:opacity-60"
            >
              {dialog.cancelText}
            </button>
          )}
          <button
            ...
            disabled={busy}
            className={`h-[52px] min-w-[156px] rounded-[10px] border px-6 text-[clamp(15px,1.04vw,18px)] font-black text-white transition hover:-translate-y-[1px] hover:brightness-110 disabled:cursor-wait disabled:opacity-60 ${isDanger ? 'border-[#66eaff] bg-[linear-gradient(135deg,#b33dff,#1269ff_62%,#18dfff)] shadow-[0_0_20px_rgba(88,134,255,0.56),inset_0_1px_0_rgba(255,255,255,0.22)]' : 'border-[#66eaff] bg-[linear-gradient(135deg,#6f43ff,#1273ff_62%,#18dfff)] shadow-[0_0_20px_rgba(88,134,255,0.54),inset_0_1px_0_rgba(255,255,255,0.22)]'}`}
          >
